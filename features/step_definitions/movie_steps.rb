...
Then /I should see the following order: (.*)$/ do |order_list|
  lst = order_list.split(%r{,\s*})
  cmp = lst.first
  lst[1..-1].each do |movie|
    step "I should see \"#{cmp}\" before \"#{movie}"
    cmp = movie
  end
...
Then /I should see all the movies/ do
  ...
  expect(Movie.all.count).to eq 10
end
